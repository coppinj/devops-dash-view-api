...
export class initDatabase1707766377556 implements MigrationInterface {
    name = 'initDatabase1707766377556'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "repository_user_accesses" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "end_date" TIMESTAMP, "repository_id" integer NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_4160af053adff07ea76d846ef45" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "repository_user_accesses" ADD CONSTRAINT "FK_f5d75ca3cbe639aa7e92bac2718" FOREIGN KEY ("repository_id") REFERENCES "repositories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "repository_user_accesses" ADD CONSTRAINT "FK_9ea51b2b46d42487723e8588e63" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "repository_user_accesses" DROP CONSTRAINT "FK_9ea51b2b46d42487723e8588e63"`);
        await queryRunner.query(`ALTER TABLE "repository_user_accesses" DROP CONSTRAINT "FK_f5d75ca3cbe639aa7e92bac2718"`);
        ...
        await queryRunner.query(`DROP TABLE "repository_user_accesses"`);
